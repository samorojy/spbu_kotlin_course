...
internal class MatrixTest {
    ...
    companion object {
        ...
        fun getCorrectData(): List<Arguments> = listOf(
                Arguments.of(
                        Matrix(arrayOf(intArrayOf(7, 1, -3),
                                intArrayOf(9, 23, -9),
                                intArrayOf(3, 6, 5)
                        )),
                        Matrix(arrayOf(
                ...
                Arguments.of(
                        Matrix(arrayOf(intArrayOf(46, 8, 7),
                                intArrayOf(26, 1, -5),
                                intArrayOf(-49, -2, 13)
                        )),
                        Matrix(arrayOf(intArrayOf(9, 3, 5),
                                intArrayOf(2, 0, 3),
                                intArrayOf(0, 1, -6)
                        )),
                        Matrix(arrayOf(
                ...
                Arguments.of(
                        Matrix(arrayOf(intArrayOf(344, 601, 4280),
                                intArrayOf(322, -122, -28),
                                intArrayOf(-13, 52, 351)
                        )),
                        Matrix(arrayOf(intArrayOf(8, 159, 5),
                                intArrayOf(25, 0, 3),
                                intArrayOf(0, 13, 0)
                        )),
                        Matrix(arrayOf(
    ...
    fun testExceptions(firstMatrix: Matrix, secondMatrix: Matrix) {
        assertThrows<IllegalArgumentException> { firstMatrix * secondMatrix }
    }

    @MethodSource("getCorrectData")
    @ParameterizedTest(name = "test{index}, {1}")
    fun matrixTimesTest(expectedMatrix: Matrix, firstMatrix: Matrix, secondMatrix: Matrix) {
