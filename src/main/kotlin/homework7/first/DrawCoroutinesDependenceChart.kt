...
class DrawCoroutinesDependenceChart : JFrame() {
    ...
    private fun initUI() {
        ...
        add(chartPanel)
        pack()
        title = "Dependence of the running time on the number of coroutines"
    ...
    private fun createDataset(): XYDataset {
        ...
        for (threads in 1..100) {
            ...
            arrayToSort.mergeSortingMainMultiCoroutines(threads)
    ...
    private fun createChart(dataset: XYDataset): JFreeChart {
        val chart = ChartFactory.createXYLineChart(
            "Dependence of execution time on the number of coroutines",
            "Coroutines",
            "Time (nanoseconds)",
            dataset,
